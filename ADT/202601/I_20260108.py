# https://atcoder.jp/contests/adt_all_20260108_1/tasks
...
def solve(n, q, h_list, lr_list):
    sgt = SegmentTree(n, op=lambda x, y: max(x, y), e=lambda: 0)
    sgt.initialize(h_list)
